...
class _GlassPalette {
  ...
  static Color border(Color accent, bool active) =>
      active ? accent.withValues(alpha: 0.65) : Colors.white.withValues(alpha: 0.12);
  static Color bg(Color accent, bool active) =>
      active ? accent.withValues(alpha: 0.18) : Colors.white.withValues(alpha: 0.06);
}
...
class _GlassButtonState extends State<GlassButton>
  ...
  @override
  Widget build(BuildContext context) {
    final accent = widget.accentColor ?? const Color(0xFF9B59B6);
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                gradient: active
                    ...
                    : null,
                color: active ? null : _GlassPalette.bg(accent, false),
                borderRadius: BorderRadius.circular(50),
                border: Border.all(
                  color: _GlassPalette.border(accent, active),
                  width: 1.5,
                ),
                boxShadow: active
                    ? [
...
class _GlassPillIconButtonState extends State<GlassPillIconButton>
  ...
  Widget build(BuildContext context) {
    final iconColor =
        widget.color ?? Colors.white.withValues(alpha: 0.88);
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  gradient: _hovered
                      ...
                      : null,
                  color: _hovered ? null : Colors.white.withValues(alpha: 0.07),
                  shape: BoxShape.circle,
                  border: Border.all(
                    color: Colors.white
                        .withValues(alpha: _hovered ? 0.28 : 0.11),
                    width: 1.2,
                  ),
                  boxShadow: _hovered
                      ? [
