import 'book_data_ru.dart';
import 'book_data_en.dart';
...
class BookData {
  ...
  static String getTitle(String lang) {
    if (lang == 'ru') return BookDataRu.title;
    if (lang == 'en') return BookDataEn.title;
    return title;
  }

  static String getAuthor(String lang) {
    if (lang == 'ru') return BookDataRu.author;
    if (lang == 'en') return BookDataEn.author;
    return author;
  }

  static String getDescription(String lang) {
    if (lang == 'ru') return BookDataRu.description;
    if (lang == 'en') return BookDataEn.description;
    return description;
  }

  static List<Chapter> getChapters(String lang) {
    if (lang == 'ru') return BookDataRu.chapters;
    if (lang == 'en') return BookDataEn.chapters;
    return chapters;
  }
